  ...
  export default function AddExercise() {
    ...
    function validate() {
      ...
      if(!exerciseData.name)newErrors.name="Name is Required";
      if(!exerciseData.category)newErrors.category="Category is Required";
      if(!exerciseData.targetMuscles)newErrors.targetMuscles="Target Muscles is Required";
      if(!exerciseData.difficulty)newErrors.difficulty="Difficulty is Required";
      ...
      <div className="w-full h-full flex flex-col py-[10px] md:py-[20px] px-[5px] md:px-[40px] gap-[10px] md:gap-[50px]">
        ...
        <div>
            <Input
              ...
              inputClassName={`border rounded-[10px] md:text-[18px] text-[14px] py-[7px] md:py-[17px] px-[11px] md:px-[23px] font-medium ${
          ...
          <div>
            <Input
              ...
              labelClassName="mb-2 text-[16px] md:text-[22px] font-[500px] text-[#547792]"
              listClassName={`w-full flex justify-between items-center border rounded-[10px] py-[10px] px-[15px] md:py-[17px] px-[23px] md:text-[18px] text-[14px] font-medium ${
                errors.category ? "border-red-500" : "border-[#94B4C1]"
              }`}
            />
          ...
          <div>
            <Input
              ...
              inputClassName={`border rounded-[10px] md:text-[18px] text-[14px] py-[7px] md:py-[17px] px-[11px] md:px-[23px] font-medium ${
                errors.targetMuscles ? "border-red-500" : "border-[#94B4C1]"
              }`}
              labelClassName="mb-2 text-[16px] md:text-[22px] font-[500px] text-[#547792]"
            />
            {errors.targetMuscles && <p className="text-red-500 text-sm">{errors.targetMuscles}</p>}
          </div>
          ...
          <div>
            <Input
              ...
              listClassName={`w-full flex justify-between items-center border rounded-[10px] py-[10px] px-[15px] md:py-[17px] px-[23px] md:text-[18px] text-[14px] font-medium ${
                errors.difficulty ? "border-red-500" : "border-[#94B4C1]"
              }`}
              labelClassName="mb-2 text-[16px] md:text-[22px] font-[500px] text-[#547792]"
            />
          ...
          <div className="flex flex-col">
            ...
            <ImageUpload
              ...
              className={`flex items-center w-fit h-fit gap-[5px] md:gap-[10px]
                px-[10px] md:px-[23px] py-[5px] md:py-[10px] rounded-[10px] 
                ${errors.image ? "border border-red-500 bg-red-50"
              : "bg-[#94B4C1]"} hover:scale-102 cursor-pointer hover:shadow-[0_0_5px_rgba(33,52,72,0.5)]
